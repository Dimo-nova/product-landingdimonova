...
import { refunds as refundsEn } from "./en/refunds";
...
import { refunds as refundsEs } from "./es/refunds";

export type { LegalSlug, LegalDoc, LegalSection, Block } from "./types";

export const LEGAL_SLUGS: LegalSlug[] = ["privacy", "terms", "cookies", "refunds"];
